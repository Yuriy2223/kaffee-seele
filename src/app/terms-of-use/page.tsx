...
export default function TermsOfUse() {
  return (
    <>
      <Head>
        <title>Умови використання | Кава для душі</title>
        <meta
          name="description"
          content="Умови використання веб-сайту Кава для душі. Ознайомтеся з правилами та умовами користування нашим сервісом."
        />
            ...
            <div className="px-8 py-12 space-y-12">
              <section>
                ...
                <div className="leading-relaxed space-y-4 text-foreground">
                  <p>
                    Ці Умови використання (&quot;Умови&quot;) встановлюють
                    правила та умови користування веб-сайтом &quot;Кава для
                    душі&quot; (далі - &quot;Сайт&quot;), що знаходиться за
                    адресою.
                  </p>
                  <p>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start space-x-3 p-3 rounded-lg border-l-4 bg-muted border-destructive">
                        ...
                        <p className="text-sm">
                          Копіювання контенту без дозволу
                        </p>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3 p-3 rounded-lg border-l-4 bg-muted border-destructive">
                        ...
                        <p className="text-sm">
                          Розміщення образливого контенту
                        </p>
                      </div>
                      <div className="flex items-start space-x-3 p-3 rounded-lg border-l-4 bg-muted border-destructive">
                        <span className="text-sm font-medium text-destructive">
              ...
              <section>
                ...
                <div className="leading-relaxed space-y-4 text-foreground">
                  <p>
                    ...
                    виключно інформаційний характер. Ми не несемо
                    відповідальності за:
                  </p>
                  <div className="space-y-3">
                    {[
              ...
              <section>
                ...
                <div className="leading-relaxed space-y-4 text-foreground">
                  <p>
                    ...
                    Всі спори, що можуть виникнути у зв&apos;язку з
                    використанням Сайту, підлягають розгляду в судах України.
                  </p>
              ...
              <section className="rounded-xl p-8 bg-muted">
                ...
                <div className="space-y-4">
                  <p className="leading-relaxed text-foreground">
                    Якщо у вас є питання щодо цих Умов використання або
                    пропозиції щодо роботи Сайту, будь ласка, зв&apos;яжіться з
                    нами:
                  </p>
