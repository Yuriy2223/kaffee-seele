...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Політика конфіденційності | Кава для душі</title>
        <meta
          name="description"
          content="Політика конфіденційності сайту Кава для душі. Дізнайтеся, як ми збираємо, використовуємо та захищаємо ваші персональні дані."
        />
          ...
          <div className="rounded-2xl shadow-lg overflow-hidden bg-warm-white">
            <div className="px-8 py-12 text-center bg-warm-brown">
              ...
              <p className="text-lg max-w-2xl mx-auto mb-6 text-warm-white/70">
                Ваша конфіденційність важлива для нас. Ця політика пояснює, як
                ми збираємо, використовуємо та захищаємо ваші персональні дані.
              </p>
                ...
                <div className="leading-relaxed text-foreground">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="rounded-lg p-4 bg-muted-green">
                      ...
                      <p className="text-sm">
                        Аналіз використання сайту для покращення
              ...
              <section>
                ...
                <div className="leading-relaxed space-y-4 text-foreground">
                  <p>
                    ...
                    досвіду використання. Cookie - це невеликі текстові файли,
                    що зберігаються на вашому пристрої.
                  </p>
              ...
              <section>
                ...
                <div className="leading-relaxed space-y-4 text-foreground">
                  <p>
                    ...
                    конфіденційності. Про суттєві зміни ми повідомимо
                    користувачів заздалегідь через сайт або електронну пошту.
                  </p>
              ...
              <section className="rounded-xl p-8 bg-muted">
                ...
                <div className="space-y-4">
                  <p className="leading-relaxed text-foreground">
                    ...
                    обробки ваших персональних даних, будь ласка,
                    зв&apos;яжіться з нами:
                  </p>
